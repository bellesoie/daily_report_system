...
<select name="${AttributeConst.EMP_ADMIN_FLG.getValue()}" id="${AttributeConst.EMP_ADMIN_FLG.getValue()}">
    ...
    <option value="${AttributeConst.ROLE_APPROVER.getIntegerValue()}"<c:if test="${employee.adminFlag == AttributeConst.ROLE_APPROVER.getIntegerValue()}"> selected</c:if>>承認者</option>
</select>
<br /><br />
